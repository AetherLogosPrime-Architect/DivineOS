...
divineos init
divineos briefing
pytest tests/ -q --tb=short   # 5,443+ tests, real DB, minimal mocks
...
- **`src/divineos/cli/`** — 210 commands across 28 modules. The public interface you type (`divineos briefing`, `divineos learn`, etc.). Thin wrappers over `core/`.
...
- **`tests/`** — 5,443+ tests, real SQLite, minimal mocks.
...
- 5,443+ tests (real SQLite, minimal mocks)
- 210 CLI commands
